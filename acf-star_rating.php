<?php
    ...
    */
    ...
    class acf_field_star_rating_plugin {
        ...
        */
        function __construct() {
            ...
            */
            ...
            // V5
            add_action( 'acf/include_field_types', [ $this, 'register_fields' ] );
        }
        ...
        *
        */
        function register_fields( $version = FALSE ) {
            // support empty $version
            if( !$version ) {
                $version = 4;
            }

            include_once( 'star_rating_v' . $version . '.php' );
            include_once( 'star_rating_average_v' . $version . '.php' );
        }
    }
