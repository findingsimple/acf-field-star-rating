    ...
    class acf_field_star_rating_average extends acf_field {
        ...
        */
        ...
        function input_admin_enqueue_scripts() {
            ...
            wp_register_script( 'jquery-raty', $this->settings['url'] . 'js/jquery.raty.min.js', [ 'acf-input' ], $this->settings['version'] );
            wp_register_script( 'acf-input-star_rating', $this->settings['url'] . 'js/input.js', [ 'acf-input' ], $this->settings['version'] );
